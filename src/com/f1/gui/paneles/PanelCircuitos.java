...
import com.f1.modelo.Circuito;
import com.f1.modelo.GanadorHistorico;
import com.f1.modelo.Piloto;
import com.f1.modelo.RecordVuelta;
...
public class PanelCircuitos extends JPanel {
    ...
    private void initComponents() {
        ...
        JLabel titleLabel = new JLabel("🛣️ Gestión de Circuitos");
