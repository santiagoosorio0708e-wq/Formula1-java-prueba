...
public class PanelConfiguracion extends JPanel {
    ...
    private void initComponents() {
        ...
        JLabel titleLabel = new JLabel("⚙️ Configuración de Carrera");
        ...
        JLabel previewTitle = new JLabel("📊 Preview de Rendimiento");
        ...
        lblPreview = new JLabel("<html><body style='color:#a0a0b4;font-size:12px;'>" +
                "<p>Selecciona un circuito y vehículo para ver el rendimiento estimado.</p></body></html>");
        ...
        F1Button btnIniciar = new F1Button("▶️ INICIAR SIMULACIÓN", F1Button.Style.PRIMARY);
    ...
    private void actualizarPreview() {
        ...
        String html = String.format(
                ...
                "<br><p style='color:#a0a0b4;'>Factor < 1.0 = más rápido/menos consumo</p>" +
                "<p style='color:#a0a0b4;'>Factor > 1.0 = más lento/más consumo</p>" +
                "</body></html>",
