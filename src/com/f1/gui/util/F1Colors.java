 ...
 * Diseño oscuro premium inspirado en la estética F1.
 */
public final class F1Colors {

    private F1Colors() {} // Evitar instanciación
    ...
    public static final Color ACCENT_GREEN = new Color(40, 200, 120);  // Verde éxito
    ...
    public static final Color ACCENT_PURPLE = new Color(138, 43, 226); // Púrpura
    ...
    public static final Color STATUS_DANGER = new Color(225, 6, 0);    // Peligro / Crítico
    public static final Color STATUS_NEUTRAL = new Color(100, 100, 120);// Neutral

    // ==================== CLIMA ====================
    public static final Color CLIMA_SECO = new Color(255, 220, 100);   // Amarillo cálido
    ...
    public static final Color CLIMA_EXTREMO = new Color(150, 30, 80);  // Rojo/Púrpura
