 ...
 * Gestiona combustible, desgaste de neumÃ¡ticos, tiempos de vuelta y pit stops.
 */
public class EstadoCarrera {
     ...
     * @return true si el combustible estÃ¡ crÃ­tico o los neumÃ¡ticos muy desgastados
     */
    ...
    /**
     * Verifica si hay alerta de pit stop (no crÃ­tico pero cercano).
     */
    ...
    /**
     * Realiza un pit stop: recarga combustible y cambia neumÃ¡ticos.
     */
    public void realizarPitStop() {
        this.enPits = true;
        this.estadoTexto = "ðŸ”§ PIT STOP";
        this.combustibleActual = COMBUSTIBLE_INICIAL;
        this.desgasteNeumaticos = 0.0;
    ...
    /**
     * Consume combustible segÃºn los parÃ¡metros dados.
    ...
    /**
     * Incrementa el desgaste de neumÃ¡ticos.
    ...
    public void retirar(String motivo) {
        this.retirado = true;
        this.estadoTexto = "âŒ Retirado: " + motivo;
    }
    ...
    /**
     * Obtiene el Ãºltimo tiempo de vuelta.
     */
