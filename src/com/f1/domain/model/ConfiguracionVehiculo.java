...
/**
 * Representa la configuraciÃ³n del vehÃ­culo elegida por el usuario antes de la carrera.
 * Incluye modo de conducciÃ³n, carga aerodinÃ¡mica, presiÃ³n de neumÃ¡ticos y estrategia de combustible.
 */
public class ConfiguracionVehiculo {
    
    /** Modos de conducciÃ³n disponibles */
    ...
    /** Niveles de carga aerodinÃ¡mica */
    public enum CargaAero {
        ...
        private final String nombre;
        private final double factorTiempo;   // < 1 = mÃ¡s rÃ¡pido en rectas, > 1 = mÃ¡s lento
        private final double factorDesgaste; // > 1 = mÃ¡s desgaste
    ...
    /** Niveles de presiÃ³n de neumÃ¡ticos */
    public enum PresionNeum {
        BAJA("Baja", 1.02, 1.15),
        ESTANDAR("EstÃ¡ndar", 1.0, 1.0),
        ALTA("Alta", 0.98, 0.88);
     ...
     * Factor < 1.0 = mÃ¡s rÃ¡pido, > 1.0 = mÃ¡s lento
     */
    ...
    /**
     * Calcula el factor de desgaste combinado de neumÃ¡ticos.
     */
    ...
    public String toString() {
        return String.format("Modo: %s | Aero: %s | NeumÃ¡ticos: %s | Combustible: %s",
