...
/**
 * Representa un vehÃ­culo de FÃ³rmula 1 con su rendimiento detallado
 * bajo diferentes modos de conducciÃ³n y condiciones climÃ¡ticas.
 */
public class Vehiculo {
    ...
    /**
     * Obtiene el modo de conducciÃ³n especificado.
     * @param modo "conduccion_normal", "conduccion_agresiva", "ahorro_combustible"
     * @return ModoConduccion con los parÃ¡metros del modo, o null si no existe
     */
    ...
    /**
     * Agrega o actualiza un modo de conducciÃ³n.
     */
    ...
    public String toString() {
        return String.format("%s %s (Motor: %s | Vel. MÃ¡x: %.0f km/h | 0-100: %.1fs)",
